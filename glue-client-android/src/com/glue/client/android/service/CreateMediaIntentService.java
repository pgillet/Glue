...
public class CreateMediaIntentService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		// Upload media
		uploadMedia(streamId, media, title, ext, path);
	...
	private void uploadMedia(Long streamId, String media, String title, String ext, String path) {
		File file = null;
		...
		try {
			glue.createMedia(streamId, title, ext, media, null, null, null, file);
