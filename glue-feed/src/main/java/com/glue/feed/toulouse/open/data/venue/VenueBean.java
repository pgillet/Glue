...
public class VenueBean {
	...
	return "VenueBean [eqNomEquipement=" + eqNomEquipement
		+ ", eqGestionnaire=" + eqGestionnaire + ", numero=" + numero
		+ ", libOff=" + libOff + ", idSecteurPostal=" + idSecteurPostal
		+ ", eqVille=" + eqVille + ", eqBibliotheque=" + eqBibliotheque
		+ ", eqMusee=" + eqMusee + ", eqCinema=" + eqCinema
		+ ", eqGalerieLieuExposition=" + eqGalerieLieuExposition
		+ ", eqConfReception=" + eqConfReception + ", eqNta=" + eqNta
		+ ", eqEnseignement=" + eqEnseignement
		+ ", eqSalleDeSpectacle=" + eqSalleDeSpectacle
		+ ", eqCentreCulturel=" + eqCentreCulturel + ", eqCaMjcMq="
		+ eqCaMjcMq + ", eqCafeConcert=" + eqCafeConcert
		+ ", eqStudioDansMusique=" + eqStudioDansMusique
		+ ", eqSecteur=" + eqSecteur + ", eqQuartier=" + eqQuartier
		+ ", xCc43=" + xCc43 + ", yCc43=" + yCc43 + ", xWgs84="
