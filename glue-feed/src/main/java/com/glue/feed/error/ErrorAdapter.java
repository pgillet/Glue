 ...
 * class are empty. This class exists as convenience for creating error
 * listener objects.
 * </p>
 * 
 * <p>
 ...
 * in it. This abstract class defines null methods for them all, so you can
 * only have to define methods for events you care about.)
 * </p>
 * 
 * <p>
 * Create a listener object using the extended class and then register it with
 * a component using the component's addErrorListener method. When an error
 * event is fired, the relevant method in the listener object is invoked and
 * the <code>ErrorEvent</code> is passed to it.
 * </p>
 *
 * @author pgillet
 */
