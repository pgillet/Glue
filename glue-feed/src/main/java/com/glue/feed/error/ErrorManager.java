...
public interface ErrorManager {
     ...
     * object. The <code>DefaultErrorListener</code> is not registered
     * anymore.
     *
     ...
     * events from this object. If there is no more registered error
     * listeners, registers a <code>DefaultErrorListener</code> again.
     *
     * @param l the error listener
     *
     * @see #addErrorListener(ErrorListener)
