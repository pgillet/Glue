...
public class GeoLocation {
    ...
    /**
     * The average radius in kilometers for a spherical approximation of the
     * figure of the Earth.
     */
     ...
     * 
     * <p>
     * Computes the bounding coordinates of all points on the surface of the
     * earth that have a great circle distance to the point represented by this
     * GeoLocation instance that is less or equal to the distance argument.
     * </p>
     * 
     * <p>
     * The average radius used for a spherical approximation of the figure of
     * the Earth is equal to 6371.01 kilometers.
     * </p>
     * 
     * <p>
     * Calling this method is equivalent to calling
     * {@link #boundingCoordinates(double, double)} with the radius argument
     * equal to 6371.01.
     * </p>
     * 
     * @param distance
     *            the distance from the point represented by this GeoLocation
     *            instance. <b>Must me expressed in kilometers</b>.
     * @return an array of two GeoLocation objects
     * @see #boundingCoordinates(double, double)
     */
