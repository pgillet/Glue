...
CREATE TABLE Glue_User (id VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, firstName VARCHAR(255), hometown VARCHAR(255), interests VARCHAR(255), lastName VARCHAR(255), password VARCHAR(255), registrationDate DATETIME, username VARCHAR(255), PRIMARY KEY (id)) ENGINE = innodb;
