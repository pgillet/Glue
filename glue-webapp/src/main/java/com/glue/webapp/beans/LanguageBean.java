...
public class LanguageBean implements Serializable {
	...
	// Get the URL the client used to make the request. The returned URL
	// contains a protocol, server name, port number, and server path, but
	// it does not include query string parameters.
	StringBuffer requestURL = request.getRequestURL();

	// Reconstruct the URL of the default document at the server's document
	// root
